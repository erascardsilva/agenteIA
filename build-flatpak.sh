...
flatpak build-bundle ../flatpak-repo ../agenteIA.flatpak org.erascardsilva.agenteIA

cd ../..

echo "--- Processo concluído! ---"
echo "O instalador foi gerado em: build/agenteIA.flatpak"
echo ""
echo "Para instalar localmente:"
echo "flatpak install --user build/agenteIA.flatpak"
echo ""
